...
/// (`SCB_VERDICT_V2`, 14 bytes — domain separation + format version).
pub const VERDICT_DOMAIN_TAG: &[u8] = b"SCB_VERDICT_V2";

/// Canonical verdict wire length:
/// 14 B tag || 32 B bounty_pda || 32 B exploit_sha256 || 32 B solver || 32 B flag_commitment || 1 B outcome.
pub const VERDICT_MSG_LEN: usize = 143;
